...
import 'package:remote_config/utils.dart';
...
class DataValueNotifier extends ValueNotifier<TabBarEntity?> {
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _fetchConfig() async {
    ...
    final rs = _remoteConfig.getString("locale_arabic");
  ...
  @override
  Widget build(BuildContext context) {
    var map = jsonDecode(_remoteConfig.getAll()['tab_bar'].toString());
    // 100
        ...
        child: Column(
          ...
          children: <Widget>[
            ValueListenableBuilder(
                ...
                builder: (context, TabBarEntity? value, child) {
                 return Text(
                    "test  ${value?.home}",
                  );
                }),
